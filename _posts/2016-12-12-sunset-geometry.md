...
thus re-expressing the unknwon product <span class="mathquill-embedded-latex">ab</span> in terms of the known products products <span class="mathquill-embedded-latex">ac</span> and <span class="mathquill-embedded-latex">cb</span>.
...
If you didn't know any geometric algebra before, and you have made it here, thank you and congratulations. I hope I have at least made you more intrigued about its possibilities. It is impossible to teach someone geometric algebra in one blog post (just as it is impossible to teach anyone classical trigonometry, complex numbers, or vector analysis in one blog post). The best places I know to learn more are:
